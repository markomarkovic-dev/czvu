<div class="slide-menu" data-menu="main-menu">
    ...
    <div class="slide-menu-body">
        ...
        <div class="mobile-menu-items">
            ...
            <a href="/czvu/projekti" class="slide-menu-item <?= activePage('projekti'); ?>">Projekti</a>
            <a href="/czvu/umjetnici" class="slide-menu-item <?= activePage('umjetnici'); ?>">Umjetnici</a>
            <a href="/czvu/vijesti" class="slide-menu-item <?= activePage('vijesti'); ?>">Vijesti</a>
            <div class="slide-menu-accordion accordion">
                <span class="slide-menu-item accordion-name">O nama</span>
                <div class="accordion-body">
                    <div class="submenu-content">
                        <a href="/czvu/centar-vizuelnih-umjetnosti" class="submenu-link">
                            <i class="ri-home-smile-2-line"></i>
                            <span>Upoznajte centar</span>
                        </a>
                        <a href="/czvu/upoznajte-tim" class="submenu-link">
