            ...
            <div class="post-meta">
              ...
              <div class="post-share">
                ...
                <div class="share-icons">
                  <a href="https://www.facebook.com/sharer.php?u=${window.location.href}&t=Home&v=3"><i class="ri-facebook-line"></i></a>
                  <a href="https://www.linkedin.com/shareArticle?mini=true&url=${window.location.href}&title=${post.title.rendered}"><i class="ri-linkedin-line"></i></a>
                  <a href="https://twitter.com/intent/tweet?text=${post.title.rendered}%20${window.location.href}"><i class="ri-twitter-line"></i></a>
