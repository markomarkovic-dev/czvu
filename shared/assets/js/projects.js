  ...
  .then((data) => {
    ...
    fetch(mediaUrl)
      ...
      .then((data) => {
        ...
        const postElement = `
        <a href="${languageCode === 'en' ? "project" : "projekat"}/${post.slug}" class="block-link" id="theatre-festival">
          ...
          document.getElementById('projects').insertAdjacentHTML('beforeend', postElement);
